CREATE TEMPORARY TABLE "temp_zonas"(
	province VARCHAR(15),
	canton VARCHAR(50),
	district VARCHAR(50)
);

INSERT INTO "temp_zonas"(province, canton, district)
VALUES
...
('San José','San José','San Sebastían'),
...
('San José','León Cortés','San Pablo'),
('San José','León Cortés','San Andrés'),
('San José','León Cortés','Llano Bonito'),
('San José','León Cortés','San Isidro'),
('San José','León Cortés','Santa Cruz'),
('San José','León Cortés','San Antonio'),
...
('Puntarenas','Coto Brus','Agua Buena'),
...
INSERT INTO "AP_Provinces" (name)
SELECT province FROM "temp_zonas"
GROUP BY province;

INSERT INTO "AP_Cantons" (name, province_id)
SELECT canton, P.id FROM "temp_zonas"
INNER JOIN "AP_Provinces" P ON P.name = "temp_zonas".province
GROUP BY canton, P.id
ORDER BY P.id, canton;

INSERT INTO "AP_Districts" (name, canton_id)
SELECT district, C.id FROM "temp_zonas"
